...
#define ANT_DEVICEID_LO_USERAPP         (u8)0x13                /* Low byte of two-byte Device # */
...
#define ANT_CHANNEL_USERAPP1             ANT_CHANNEL_1

#define ANT_CHANNEL_TYPE_USERAPP1        CHANNEL_TYPE_MASTER 
